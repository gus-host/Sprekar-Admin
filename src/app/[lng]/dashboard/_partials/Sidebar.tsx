    ...
    >
      {error ? (
        ...
        <>
          ...
          <div className="flex flex-col justify-between gap-[35px] relative flex-1 overflow-y-auto hover:scrollbar-thin scrollbar-thumb-white scrollbar-track-transparent min-h-[344px] transition-all scrollbar-none">
            <div className="">
